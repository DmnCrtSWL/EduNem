...
export default function Icon({ name, size = 18, color = 'currentColor', className = '', style = {} }) {
  const iconPaths = {
    ...
    'arrow-left': { strokeWidth: 2.5, d: "M10 19l-7-7m0 0l7-7m-7 7h18" },
    ...
    'edit-2': { strokeWidth: 2, d: "M17 3a2.828 2.828 0 114 4L7.5 20.5 2 22l1.5-5.5L17 3z" },
    ...
    circle: { strokeWidth: 2, d: "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" },
